  ...
  xdg = {
    ...
    desktopEntries = {
      ...
      gitbutler-nightly = {
        ...
        exec = "env NIXOS_XDG_OPEN_USE_PORTAL=0 APPIMAGE=/opt/appimages/git-butler-nightly_latest.AppImage APPIMAGE_GTK_THEME=Adwaita:dark /opt/appimages/git-butler-nightly_latest.AppImage %U";
